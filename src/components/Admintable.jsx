...
export default function Admintable() {
  ...
  return (
    ...
    <button onClick={openDialog} className="bg-[rgb(212,121,58)] hover:bg-[#ecbc9a] w-[100px] rounded-md my-4 ml-3 py-2 text-black font-medium text-xl">
        Tilføj
    </button>
    {dialogOpen && (
  ...
  <tr className="border-black border-solid border-2 text-center">
    ...
    <td onClick={openDialog} className="border-black border-solid border-2 hover:text-[#d4793a] cursor-pointer text-center align-middle">{editIcon}</td>
