      ...
      {data.map((item) => (
        <div key={item.product_id} className="bg-white m-4 border border-gray-200 rounded-md">
          <div className="relative w-[200px] h-[317px] top-0 left-0 ">
            ...
            <button className="absolute w-[115px] h-[45px] top-[259px] left-[40px] all-[unset] box bg-[#d4793a] rounded-[4px] hover:bg-[#ecbc9a] [font-family:'Roboto-Regular',Helvetica] font-normal text-black text-[20px] text-center tracking-[0] leading-[normal] ">
              Læg i kurv
            </button>
