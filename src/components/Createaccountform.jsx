...
export default function Createaccountform() {
  ...
  return (
    <div className="flex flex-col justify-center w-full max-w-lg py-8 m-auto text-black px-4">
      <div className="bg-[#e8e3d8] rounded">
        <h2 className="py-3 text-2xl font-medium text-center md:text-2xl">Opret bruger</h2>
