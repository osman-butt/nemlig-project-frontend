...
export default function Loginform() {
  ...
  return (
    <div className="w-full max-w-lg m-auto mt-20 p-4">
      <div className="bg-[#e8e3d8] rounded">
        <h2 className="font-medium text-2xl py-3 text-center">Log ind</h2>
        ...
        <p className="py-4 font-medium underline cursor-pointer text-center">Glemt password?</p>
      </div>
    </div>
  );
}
